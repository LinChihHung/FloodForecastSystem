...
class BME:
    def __init__(self, stationNameList, obsRainDict, simRainDict):
        self.stationNameList = stationNameList
        self.obsRainDict = obsRainDict
...
if __name__ == '__main__':
    ...
    # test = BME(stationNameList=stationNameList, obsRainDict=obsRainDict, simRainDict=simRainDict)
